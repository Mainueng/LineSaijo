<div id="container">
	...
	<div id="content">
		<div class="page-header">
			<div class="container-fluid">
				<h1 class="pl-3">Problems</h1>
				<div class="float-right">
					<a href="<?php echo site_url('api/problems/form/')."?&method=add"?>" data-toggle="tooltip" data-placement="top" title="Add Service Cost" class="btn btn-primary font-14"><i class="fas fa-plus"></i></a>
				</div>
			</div>
		</div>
		<div class="row p-4">
			<div class="col-9 px-2">
				<div class="card">
					<div class="card-header">
						<i class="fas fa-list mr-1"></i> Problems
					</div>
					<div class="card-body">
							...
							<table id="job-list-table" class="table table-hover">
								<thead>
									<tr>
										...
										<th scope="col" class="text-center">Problem Name EN</th>
										<th scope="col" class="text-center">Problem Name Th</th>
								...
								<tbody>
									...
									if ($this->data['problems']) {
										...
										foreach ($this->data['problems'] as $result) { ?>
											<tr>
												...
												<td class="text-center">
													<a href="<?php echo site_url('api/problems/form/'.$result['id']).'?&method=edit'; ?>"><i class="fas fa-edit"></i> Edit</a>
												</td>
											</td>
										</tr>
									<?php } } ?>
				...
				<div class="filter-container card">
					...
					<div class="card-body">
						<div class="form-group">
							<label for="name_en">Problems Name En</label>
							<input type="text" class="form-control" id="name_en" name="filter_problem_name_en" placeholder="Problem Name En">
						</div>
						<div class="form-group">
							<label for="name_th">Problems Name Th</label>
							<input type="text" class="form-control" id="name_th" name="filter_problem_name_th" placeholder="Problem Name Th">
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	$('#button-filter').on('click', function() {
		...
		var filter_problem_name_en = $('input[name=\'filter_problem_name_en\']').val();

		if (filter_problem_name_en) {
			url += '&filter_problem_name_en=' + encodeURIComponent(filter_problem_name_en);
		}

		var filter_problem_name_th = $('input[name=\'filter_problem_name_th\']').val();

		if (filter_problem_name_th) {
			url += '&filter_problem_name_th=' + encodeURIComponent(filter_problem_name_th);
		}
