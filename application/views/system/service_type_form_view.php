		...
		<div class="page-header">
			<div class="container-fluid">
				...
				<div class="float-right ml-1">
					<a href="<?php echo site_url('api/service-type'); ?>" data-toggle="tooltip" data-placement="top" title="Cancel" class="btn btn btn-default font-14"><i class="fas fa-reply"></i></a>
				</div>
				<div class="float-right ml-1">
					<a href="#" data-toggle="tooltip" data-placement="top" title="Add Service Type" class="btn btn-primary font-14"><i class="fas fa-save"></i></a>
				</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<i class="fas fa-user-edit"></i> Service Infomation Form
					</div>
					<div class="card-body">
						<form class="form-inline" action="<?php echo site_url('api/service-type/form/'.$this->data['service_code'])."?&method=".$this->data['method']; ?>" method="post">
							...
							<div class="form-group w-100 required">
								...
								<div class="col-10 form-input">
									<input type="text" name="service_name_en" value="<?php echo ucfirst($this->data['service_name_en']); ?>" id="input-service_name_en" class="form-control w-100" placeholder="Service Name En">
							...
							<div class="form-group w-100 required">
								...
								<div class="col-10 form-input">
									<input type="text" name="service_name_th" value="<?php echo ucfirst($this->data['service_name_th']); ?>" id="input-service_name_th" class="form-control w-100" placeholder="Service Name Th">
...
<script type="text/javascript">
	$(".btn-primary").click(function(){
		...
		if ($('#input-service_name_en').val() && $('#input-service_name_en').val().length > 0) {
		...
		if ($('#input-service_name_th').val() && $('#input-service_name_th').val().length > 0) {
		...
		if ($('#input-service_name_en').val() && $('#input-service_name_th').val()) {
			$("form").submit();
		}
